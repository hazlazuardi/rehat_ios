      ...
      <KeyboardAwareScrollView
        ...
        <View style={{paddingTop: insets.top + sizes.padding.lg}}>
          ...
          <View
            ...
            <View
              ...
              <EmotionCategoryButton
                disabled
                title={journal.emotionCategory}
                width={120}
                variant={toAssetCase(journal.emotionCategory)}
              />
              <View>
                <Text style={{...styles.text.header2, fontWeight: '300'}}>
                  I'm feeling
                </Text>
            ...
            <View
              ...
              <View style={{gap: sizes.padding.sm}}>
                ...
                <Text style={styles.text.body2Transparent}>
                  at {timeString}
                </Text>
              </View>
            </View>
            ...
            <TextArea
              ...
              placeholder={'Title'}
              onEndEditing={titleValue =>
                handleWriteThoughts('title', titleValue)
              }
              value={journal.title}
            />
            <TextArea
              ...
              onEndEditing={thoughtValue =>
                handleWriteThoughts('thoughts', thoughtValue)
              }
              ...
              <>
                ...
                <View
                  ...
                  <Pressable onPress={onPressRemovePhoto}>
                    <Text style={{...styles.text.semi1, color: 'red'}}>
                      Remove Photo
                    </Text>
                  </Pressable>
                </View>
          ...
          <View
            style={{
              paddingHorizontal: sizes.padding.md,
              marginBottom: sizes.padding.lg * 2,
            }}>
            <PrimaryButton
              onPress={() =>
                navigation.reset({
