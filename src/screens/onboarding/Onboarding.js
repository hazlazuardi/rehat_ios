        ...
        <SafeAreaView style={{marginBottom: 100}}>
          <View style={{padding: sizes.padding.md, gap: sizes.gap.lg}}>
            <View style={{padding: 24}}>
              ...
              <View style={{marginTop:50, padding:50, backgroundColor:colors.white, borderColor:colors.orange, borderWidth:5, borderRadius:30}}>
                <Text style={{...styles.text.body2, color:'black', textAlign:'left'}}>
              ...
              <Pressable onPress={()=>{navigation.navigate('Onboarding Detail One')}}>
                <View
                  style={{
              ...
              <Text style={{...styles.text.body3, color:'white', textAlign:'center', paddingTop:20}}>
                  Skip for now
                </Text>
            </View>
          </View>
